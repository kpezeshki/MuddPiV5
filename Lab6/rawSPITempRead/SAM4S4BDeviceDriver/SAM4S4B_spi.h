...
void spiInit(uint32_t clkdivide, uint32_t cpol, uint32_t ncpha) {
    ...
    pioPinMode(PIO_PA11, PIO_PERIPH_A); // CS (chip select)
    pioPinMode(PIO_PA12, PIO_PERIPH_A); // MISO
    pioPinMode(PIO_PA13, PIO_PERIPH_A); // MOSI
    pioPinMode(PIO_PA14, PIO_PERIPH_A); // SCK
